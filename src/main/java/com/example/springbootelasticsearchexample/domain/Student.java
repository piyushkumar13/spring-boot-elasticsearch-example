...
public class Student {
    ...
    // usually, suffix name used normally is keyword.
    @MultiField(mainField = @Field(type = FieldType.Text), otherFields = {@InnerField(suffix = "keywsuffix", type = FieldType.Keyword)})
